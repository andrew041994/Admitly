...
const documents: Record<string, LegalDocument> = {
  ...
  refunds: {
    ...
    sections: [
      { heading: 'Canceled events', body: 'Tickets are eligible for refund when an event is canceled, after Admitly verifies the event status, original order, payment, amount, and any prior refund or dispute. This does not limit any additional remedy required by applicable Guyanese law.' },
      { heading: 'Postponed or rescheduled events', body: 'A ticket remains valid for the announced rescheduled date. Postponement or rescheduling alone does not automatically create a refund right, except where applicable law requires one.' },
  ...
  organizers: {
    ...
    sections: [
      ...
      { heading: 'Changes, cancellations, and refunds', body: 'Event creators must promptly report changes or cancellation. Canceled events are eligible for refunds subject to applicable Guyanese law. Tickets remain valid for a postponed or rescheduled date and postponement alone does not automatically create a refund right except where law requires one.' },
  ...
  buyers: {
    ...
    sections: [
      ...
      { heading: 'Canceled events', body: 'Canceled-event tickets are eligible for refund after the original order and payment state are verified, subject to applicable Guyanese law. Refund requests are operationally handled through the original purchaser and order owner unless Admitly expressly supports another lawful process.' },
      { heading: 'Postponement, rescheduling, and attendance', body: 'Tickets remain valid for an announced rescheduled date. Postponement, rescheduling, a change of plans, or non-attendance does not automatically create a discretionary refund right, except where applicable law requires one.' },
