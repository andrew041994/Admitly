...
class EventReminderLog(TimestampMixin, Base):
    ...
    __table_args__ = (
        UniqueConstraint("event_id", "user_id", "reminder_type", name="uq_event_reminder_logs_event_user_type"),
    )
    ...
    reminder_type: Mapped[ReminderType] = mapped_column(
        Enum(ReminderType, name="reminder_type"), nullable=False, index=True
    )
