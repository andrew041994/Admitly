...
class Event(TimestampMixin, Base):
    ...
    doors_open_at: Mapped[datetime | None] = mapped_column(
    ...
    timezone: Mapped[str] = mapped_column(
        String(64), nullable=False, default="America/Guyana"
    )
    status: Mapped[EventStatus] = mapped_column(
        db_enum(EventStatus, name="event_status"),
        nullable=False,
        default=EventStatus.DRAFT,
    )
    visibility: Mapped[EventVisibility] = mapped_column(
        db_enum(EventVisibility, name="event_visibility"),
        nullable=False,
    ...
    is_location_pinned: Mapped[bool] = mapped_column(
