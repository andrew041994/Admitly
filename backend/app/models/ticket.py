...
class Ticket(TimestampMixin, Base):
    ...
    status: Mapped[TicketStatus] = mapped_column(
        db_enum(TicketStatus, name="ticket_status"),
        nullable=False,
    ...
    purchaser: Mapped["User"] = relationship(
        back_populates="purchased_tickets", foreign_keys=[purchaser_user_id]
    )
    owner: Mapped["User"] = relationship(
        back_populates="owned_tickets", foreign_keys=[owner_user_id]
    )
    ...
    voided_by: Mapped["User | None"] = relationship(
        back_populates="voided_tickets", foreign_keys=[voided_by_user_id]
    )
