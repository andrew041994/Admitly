...
def get_organizer_event_finance_summary(
    ...
    return EventFinanceSummaryResponse(
        event_id=summary.event_id,
        event_status=summary.event_status,
        gross_face_value_amount=float(summary.gross_face_value_amount),
        ...
        comp_order_count=summary.comp_order_count,
        comp_ticket_count=summary.comp_ticket_count,
        comp_face_value=float(summary.comp_face_value),
